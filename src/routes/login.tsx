  ...
  head: () => ({
    meta: [
      { title: "Sign in — SENTRA" },
      {
        name: "description",
        content:
          "Sign in to review verifiable agent track records and delegate USDC through SENTRA.",
      },
    ],
  }),
  component: Login,
...
function Login() {
  ...
  const submit = async (e: FormEvent) => {
    ...
    try {
      ...
      toast.push(`Auth failed: ${message}`);
    } finally {
      setBusy(false);
    }
  };
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center gap-3 mb-8">
          ...
          <p className="text-xs text-muted-foreground">
            Review track records and delegate capital on Arc.
          </p>
        </div>
