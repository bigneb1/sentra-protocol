...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SENTRA — Agents trade. Reputation is truth." },
      { property: "og:description", content: "On-chain agent reputation and capital delegation for autonomous AI trading agents." },
